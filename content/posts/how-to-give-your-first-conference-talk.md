+++
title = "How to Give Your 1st Conference Talk!"
date = 2026-08-22T12:00:00+01:00

tags = ["conference", "publicspeaking", "career"]
author = "Madhur"
showToc = true
TocOpen = false
draft = false
hidemeta = false
comments = false
description = "Every job hides a story worth telling. Here's how curiosity turns into a conference talk, and everything I wish someone had told me about CFPs before my first one."
...
[cover]
image = "/images/first-conference-talk-cover.png"
alt = "A speaker on stage at a tech conference, mid-sentence, slide deck glowing behind them"
caption = "cover"
...
<!-- TODO: Replace with a wide hero shot, ideally you on stage, mid-gesture, not mid-blink. -->
![A speaker mid-talk, slide deck glowing behind them, audience in soft focus](/images/first-conference-talk-cover.png)

## The Goldmine Nobody Told You About

Here is something nobody tells you on day one of a new job: every role, at every company, if you do it right, quietly turns into a research project.

You get handed a ticket. The ticket asks a small, boring question. And if you actually chase the answer instead of just closing the ticket, that question drags you sideways into a rabbit hole you did not know existed. Suddenly you are three tabs deep into a spec, then a mailing list thread from 2019, then someone's changelog, then you are debugging something that was never really your job, purely because you have to know.
...
<!-- TODO: A photo from your actual first talk, wide shot of you at the podium works well here. -->

My own first talk was about Juju, a tool I genuinely had no idea existed six months before I stood on a stage and explained it to a room full of strangers.

It did not start with "I want to give a talk." It started with a much smaller, much more selfish question at work: *how do I stop being the person who has to ask someone else every time our infrastructure breaks?* I wanted to actually own the thing my team was running, not just poke at it when it was on fire.
...
<!-- TODO: A candid hallway-track photo, conversation over coffee, badge visible, feels great here. -->
...
**The timing catches people off guard.** CFPs for a conference almost always close three to six months *before* the event itself. If you are thinking about speaking at something happening in the fall, the CFP window was probably open in the spring. The lesson: do not wait for the "right" idea to feel finished. Submit the rabbit hole you are currently in the middle of, the CFP deadline will likely land before you have fully finished digging anyway.

**Where to actually find them:**

- [Sessionize](https://sessionize.com/) — widely used CFP platform, browsable by topic and open dates.
- [Papercall](https://www.papercall.io/) — another common submission platform, great for discovering smaller/regional conferences.
- [confs.tech](https://confs.tech/) — a curated, filterable list of tech conferences and their CFP deadlines.
...
<!-- TODO: Optional - a simple graphic/timeline showing "CFP opens -> CFP closes -> Notifications -> Conference." A visual timeline works really well here. -->
...
- [Sessionize](https://sessionize.com/) — CFP platform and speaker profiles
- [Papercall](https://www.papercall.io/) — CFP platform, strong for regional/community conferences
- [confs.tech](https://confs.tech/) — curated conference and CFP deadline list
- [Juju Does Everything. Here Is What That Is Like.](/posts/juju-does-everything/) — the talk referenced in this post
